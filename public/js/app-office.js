...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__about_about_index_js__ = __webpack_require__(42);
...
if (filtre) {
  filtre.addEventListener('change', function () {
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/admin/about/to-get', {
      params: {
        toGet: filtre.value
      }
